...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `unitedcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ unitedcore-node add wallet-service');
      console.log('    $ unitedcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ unitedcore-node remove wallet-service');
      console.log('    $ unitedcore-node remove insight-api');
      console.log();
    });
