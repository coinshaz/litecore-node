...
/**
 * Will return the path and default unitedcore-node configuration. It will search for the
 * configuration file in the "~/.unitedcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.unitedcoin');
  var defaultConfigFile = path.resolve(defaultPath, './unitedcore-node.json');
